...
export const PROFESSIONS = {
  ...
  accountant: {
    ...
    modules: ['dashboard','clients','invoices','contracts','cashbook','bank','payroll','prro','tax-calendar','payment-calendar','currency','templates','passwords','notes','documents','reports','tax-reports','support'],
    quickActions: [
      { label: 'Новий клієнт',    iconName: 'user',     action: 'new-client' },
  ...
  beauty: {
    ...
    modules: ['dashboard','clients','appointments','services','finances','cashbook','bank','payroll','prro','warehouse','hr','payment-calendar','notes','reports','support'],
    quickActions: [
