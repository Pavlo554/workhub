...
export const PROFESSIONS = {
  freelancer: {
    ...
    modules: ['dashboard','clients','projects','invoices','contracts','cashbook','bank','tasks','timer','kanban','portfolio','templates','payment-calendar','client-analytics','passwords','notes','documents','reports','support'],
    quickActions: [
  ...
  accountant: {
    ...
    modules: ['dashboard','clients','invoices','contracts','cashbook','bank','payroll','prro','tax-calendar','payment-calendar','client-analytics','currency','templates','passwords','notes','documents','reports','support'],
    quickActions: [
      { label: 'Новий клієнт',    iconName: 'user',     action: 'new-client' },
  ...
  beauty: {
    ...
    modules: ['dashboard','clients','appointments','services','finances','cashbook','bank','payroll','prro','warehouse','hr','payment-calendar','client-analytics','notes','reports','support'],
    quickActions: [
