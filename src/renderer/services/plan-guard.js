  ...
  modal.innerHTML = `
    <div class="upgrade-modal">
      ...
      <div class="upgrade-features">
        <div class="upgrade-feature">✓ Необмежена кількість клієнтів</div>
        <div class="upgrade-feature">✓ Необмежена кількість рахунків</div>
        <div class="upgrade-feature">✓ Експорт PDF</div>
        <div class="upgrade-feature">✓ Розширена аналітика</div>
      </div>
      <div class="upgrade-actions">
        <button class="btn btn-primary upgrade-btn-pro" id="upgrade-go-pro">
          ⭐ Оновити до PRO — ₴299/міс
        </button>
...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .upgrade-feature { font-size:13px; font-weight:600; color:#34D399; }
