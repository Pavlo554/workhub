// src/renderer/utils/icons.js — centralized Lucide-style SVG icon library
// stroke="currentColor" so icons inherit color from CSS
...
const p = {
  ...
  'content-plan':
    '<rect width="14" height="20" x="5" y="2" rx="2"/><path d="M12 18h.01"/><line x1="9" y1="7" x2="15" y2="7"/><line x1="9" y1="11" x2="13" y2="11"/>',
  accounts:
  ...
  kanban:
    '<rect width="5" height="18" x="3" y="3" rx="1"/><rect width="5" height="12" x="10.5" y="3" rx="1"/><rect width="5" height="8" x="18" y="3" rx="1"/>',
  templates:
  ...
  calculator:
    '<rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/><path d="M16 18h.01"/><line x1="12" y1="10" x2="16" y2="10"/>',
  smartphone:
  ...
  'payment-calendar':
    '<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M8 15h.01M12 15h.01M16 15h.01"/>',
  refresh:
  ...
  'bar-chart':
    '<path d="M3 3v18h18"/><line x1="7" y1="10" x2="7" y2="18"/><line x1="12" y1="5" x2="12" y2="18"/><line x1="17" y1="14" x2="17" y2="18"/>',
  mail:
  ...
  newspaper:
    '<path d="M4 3h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M8 7h8"/><path d="M8 11h8"/><path d="M8 15h4"/>',
  idea:
...
export function icon(name, size = 16) {
  return svg(p[name] || p.dashboard, size)
}
